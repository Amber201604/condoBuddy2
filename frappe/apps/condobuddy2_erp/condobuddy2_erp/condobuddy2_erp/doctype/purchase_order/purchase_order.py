...
class PurchaseOrder(BuyingController):
	...
	if TYPE_CHECKING:
		...
		custom_sub_flow_name: DF.Link | None
...
@frappe.whitelist()
def make_receive_and_verify(source_name, target_doc=None, args=None):
	if args is None:
		args = {}
	...
	doc = get_mapped_doc(
		...
		source_name,
		{
			...
			"Purchase Order Item": {
				"doctype": "Table Ordered vs Received",
				"field_map": {
